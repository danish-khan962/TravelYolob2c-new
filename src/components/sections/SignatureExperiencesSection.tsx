            ...
            >
              {displayData.map((experience, index) => (
                <SwiperSlide key={index}>
                  <Link
                    href={experience.slug ? `/destinations/${experience.slug}` : '#'}
                    className="block relative max-w-[350px] w-full transition-transform duration-300 ease-out hover:scale-105"
                    style={{
